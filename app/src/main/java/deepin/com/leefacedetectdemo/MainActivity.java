...
public class MainActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.id_face_detect1).setOnClickListener(this);
        findViewById(R.id.id_face_detect2).setOnClickListener(this);
        findViewById(R.id.id_real_time_face_detect).setOnClickListener(this);
    }

    private void detectImage2() {
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.id_real_time_face_detect:{
                startActivity(new Intent(MainActivity.this, TakeCameraFrameToDetectActivity.class));
                break;
            }
            case R.id.id_face_detect1:{
                detectImage1();
                break;
            }
            case R.id.id_face_detect2:{
                detectImage2();
                break;
            }
        }
